<?php
    ...
    class instagram_request{
        ...
        function __construct($username, $password, $functions = null){
            ...
            $this->guid       = $this->get_guid();
            $this->adid       = $this->get_adid();
            $this->phone_id   = $this->get_phone_id();
            $this->user_agent = 'Instagram 215.0.0.27.359 Android (25/7.1.2; 160dpi; 540x960; Google/google; google Pixel 2; x86; android_x86; tr_TR; 337202363)';
        }
        ...
        public function cache($name, $desc = false, $json = false){
            ...
            if($this->username != null){
                ...
                if(!file_exists($this->cache_path.$this->username.'/users/')){
                    ...
                    chmod($this->cache_path.$this->username.'/users/', 0777);
                }else{
                    chmod($this->cache_path.$this->username.'/users/', 0777);
                }
            }
        ...
        public function request($url = '', $type = 'GET', $data = null, $header = null, $cookie = null, $user_cookie = true){
            ...
            $headers_default = [
                ...
                'X-IG-Device-ID'       => $this->get_guid(),
                'X-IG-Android-ID'      => $this->get_device_id(),
